...
# get weather for given city and return json of temperature and climate
def get_weather_api(city: str) -> dict:
    ...
    Returns:
        dict: A dictionary of temperature and climate
    ...
    if city == "Bangalore" or city == "Bengaluru":
        return {"temperature": 25, "climate": "Cloudy"}
    elif city == "Hyderabad":
...
# get weather response from gemini using the agent with a tool
